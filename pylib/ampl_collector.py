...
class AmplCollector:
    ...
    def init_storage(self,ampl_obj):
        ...
        for k in self.results:
            ...
            elif k in ['New_old_decom','C_inv_phase_tech','C_op_phase_tech','C_op_phase_res','Decision_tracking']:
                index_elem = result.index.get_level_values(1).unique()
    ...
    def update_storage(self, ampl_obj,curr_years_wnd,i):
        for k in self.results:
            ...
            if k in ['New_old_decom','F_decom','C_inv_phase','C_inv_phase_tech','C_op_phase_tech','C_op_phase_res','Decision_tracking']:
